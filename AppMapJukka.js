...
export default function App() {
    ...
    const findAddress = () => {
        fetch(`https://www.mapquestapi.com/geocoding/v1/address?key=cKyejkBu38157GgPd7U2uLK7ODxtUao1&inFormat=kvp&outFormat=json&location=${typedAddress}&thumbMaps=false`, {
        })
